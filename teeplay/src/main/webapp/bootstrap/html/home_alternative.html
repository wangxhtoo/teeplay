...
<meta charset="utf-8" />
<title>{re}start is a clean, multipurpose HTML template</title>
...
<section id="slider_wrapper" class="container">
     <div id="main_flexslider" class="flexslider">
          <ul class="slides">
               ...
               <li class="item" style="background-image: url(images/s2.jpg)">
                    <div class="container">
                         <div class="carousel-caption">
               ...
               <li class="item" style="background-image: url(images/s3.jpg)">
                    <div class="container">
                         <div class="carousel-caption">
