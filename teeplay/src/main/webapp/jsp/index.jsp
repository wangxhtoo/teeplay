		  ...
		  <div class="slider">
	      	<div class="slider-wrapper theme-default">
	            <div id="slider" class="nivoSlider">
	                <img src="<%=basePath %>/images/1.jpg" data-thumb="<%=basePath %>/images/1.jpg" alt="" />
	                <img src="<%=basePath %>/images/2.jpg" data-thumb="<%=basePath %>/images/2.jpg" alt="" />
	                <img src="<%=basePath %>/images/3.jpg" data-thumb="<%=basePath %>/images/3.jpg" alt="" />
	                <img src="<%=basePath %>/images/4.jpg" data-thumb="<%=basePath %>/images/4.jpg" alt="" />
	            </div>
	        </div>
   		</div>
		<!------End Slider ------------>			     
